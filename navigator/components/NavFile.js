/* 
	...
	CSP-Compliant NavFile Component with IconEngine.
*/
...
export class NavFile extends NavEntry {
	...
	apply_visuals(isLink = false) {
		const res = IconEngine.resolveFile(this.filename, this.path_str(), isLink);
...
export class NavFileLink extends NavFile {
	...
	constructor(path, stat, nav_window_ref, link_target) {
		...
		link_icon.className = "fas fa-link nav-item-symlink-symbol-file";
